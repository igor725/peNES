...
constexpr std::array<InstItem, 256> CPU_INSTS = {
    ...
    InstItem(),
    InstItem(),
    InstItem(InstName::ADC, AddrMode::ZeroPageX, 2, 4),
    InstItem(),
    InstItem(),
    ...
    InstItem(),
    InstItem(),
    InstItem(InstName::ADC, AddrMode::AbsoluteX, 3, 4),
    ...
    InstItem(),
    InstItem(),
    InstItem(InstName::SBC, AddrMode::Absolute, 3, 4),
    ...
    InstItem(),
    InstItem(),
    InstItem(InstName::SBC, AddrMode::ZeroPageX, 2, 4),
